...
public:
	 ...
	 */
	BRKGA(double alpha,GraphCost *_g, Instance & _instance, Heuristic& _gen_sol, unsigned n, unsigned p, double pe, double pm, double rhoe,
...
template <class Decoder, class RNG>
BRKGA<Decoder, RNG>::BRKGA(double _alpha,GraphCost *_g, Instance &_instance, Heuristic &_construtivo, unsigned _n, unsigned _p, double _pe, double _pm, double _rhoe,
